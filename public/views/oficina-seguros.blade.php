                    ...
                    <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                        <div class="card">
                            ...
                            <div class="card-header" role="tab" id="headingOne1">
                                ...
                                <h5 class="mb-0 d-flex justify-content-between">
                                    Certificacion del titular en las certificaciones que tenemos en universidad (Vida y seguros). <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingTwo2">
                                ...
                                <h5 class="mb-0 d-flex justify-content-between">
                                    Contar con 1 operador. <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card">  
                            <div class="card-header" role="tab" id="headingThree3">
                                ...
                                <h5 class="mb-0 d-flex justify-content-between">
                                    Colocación anual de acuerdo al plan de negocio. <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                                </a>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header" role="tab" id="headingThree3">
                                ...
                                <h5 class="mb-0 d-flex justify-content-between">
                                    Cartera: 84% LIMRA (Life insurance marketing  and research association) Y 90.5% IGC indice general de conservación. <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingTwo2">
                                ...
                                aria-expanded="false" aria-controls="collapseTwo2">
                                <h5 class="mb-0 d-flex justify-content-between">
                                    Contar con 1 operador certificado. <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card">  
                            <div class="card-header" role="tab" id="headingThree3">
                                ...
                                aria-expanded="false" aria-controls="collapseThree3">
                                <h5 class="mb-0 d-flex justify-content-between">
                                    Colocación anual mdrt. <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card">  
                            <div class="card-header" role="tab" id="headingThree3">
                                ...
                                aria-expanded="false" aria-controls="collapseThree3">
                                <h5 class="mb-0 d-flex justify-content-between">
                                    Colocación anual mdrt + 10%. <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                                </a>
                            </div>
                        </div>
